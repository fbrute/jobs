class CombattantsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @combattant.save
        format.html { redirect_to @combattant, notice: 'Le Combattant a été créé avec succès.' }
  ...
  def update
    respond_to do |format|
      if @combattant.update(combattant_params)
        format.html { redirect_to @combattant, notice: 'Le combattant a été mis à jour avec succès.' }
  ...
  def destroy
    @combattant.destroy
    respond_to do |format|
        format.html { redirect_to combattants_url, notice: 'Le combattant a été supprimé avec succès.' }
